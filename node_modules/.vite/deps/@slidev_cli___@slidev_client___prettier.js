...
function Tt(t, e) {
  var _a3;
  let r = Vu.get(e);
  return ((_a3 = t.match(r)) == null ? void 0 : _a3.length) ?? 0;
}
var Wu = /\r\n?/g;
function hr(t) {
  return ne(0, t, Wu, ze);
...
function te(t) {
  ...
  return t.type === T ? { ...t, breakContents: te(t.breakContents), flatContents: te(t.flatContents) } : t.type === x ? { ...t, contents: te(t.contents), expandedStates: (_a3 = t.expandedStates) == null ? void 0 : _a3.map(te) } : t.type === S ? { type: "fill", parts: t.parts.map(te) } : t.contents ? { ...t, contents: te(t.contents) } : t;
}
function Ur(t) {
  ...
  function n(o, i, D) {
    ...
    if (o.type === g) {
      let s = ((_a3 = D == null ? void 0 : D[i + 1]) == null ? void 0 : _a3.type) === N;
    ...
    if (o.type === N) return ((_b = D == null ? void 0 : D[i - 1]) == null ? void 0 : _b.type) === g && D[i - 1].hard ? void 0 : "breakParent";
...
var _t, _e, _n, _u, _r2, _Rt_instances, o_fn, _a;
var Rt = (_a = class {
  constructor() {
  ...
  markPosition() {
    if (__privateGet(this, _u).length + __privateGet(this, _r2).length >= 2) throw new Error("There are too many 'cursor' in doc.");
    __privateGet(this, _r2).push(__privateGet(this, _n) + __privateGet(this, _e).length);
  }
  write(e) {
    __privateSet(this, _e, __privateGet(this, _e) + e);
  }
  trim() {
    let { text: e, count: r } = et(__privateGet(this, _e));
    return __privateSet(this, _e, e), __privateMethod(this, _Rt_instances, o_fn).call(this), r;
  }
  finish() {
    return __privateMethod(this, _Rt_instances, o_fn).call(this), { text: __privateGet(this, _t).join(""), positions: __privateGet(this, _u) };
  }
}, _t = new WeakMap(), _e = new WeakMap(), _n = new WeakMap(), _u = new WeakMap(), _r2 = new WeakMap(), _Rt_instances = new WeakSet(), o_fn = function() {
  let e = __privateGet(this, _e);
  e !== "" && (__privateGet(this, _t).push(e), __privateSet(this, _n, __privateGet(this, _n) + e.length), __privateSet(this, _e, ""));
  for (let r of __privateGet(this, _r2)) __privateGet(this, _u).push(Math.min(r, __privateGet(this, _n)));
...
var he = co;
var _Lt_instances, t_fn, e_fn, _a2;
var Lt = (_a2 = class {
  constructor(e) {
...
function Fo(t, e, r) {
  ...
  let { filter: n } = r;
  if (!n) return [];
  let u, o = (((_a3 = r.getChildren) == null ? void 0 : _a3.call(r, t, r)) ?? [...ye(t, { getVisitorKeys: r.getVisitorKeys })]).flatMap((s) => (u ?? (u = [t, ...e]), n(s, u) ? [s] : on(s, u, r))), { locStart: i, locEnd: D } = r;
...
function an(t, e) {
  ...
  for (let [l, m] of c.entries()) {
    ...
    if (u ? (m.placement = A, B = [m]) : B = [f, C, h, _, P], p && (f.placement = A, f.enclosingNode = d, f.precedingNode = F, f.followingNode = E), A === "ownLine") D(...B) || (E ? ce(E, f) : F ? fe(F, f) : d ? re(d, f) : re(_, f));
...
function sn(t, e) {
  ...
  for (i = r; i > 0; --i) {
    ...
    if (((_b = (_a3 = e.printer).isGap) == null ? void 0 : _b.call(_a3, c, e)) ?? /^[\s(]*$/.test(c)) o = e.locStart(D);
    else break;
  }
...
function _o(t, e) {
  ...
  if ((_a3 = u.isBlockComment) == null ? void 0 : _a3.call(u, r)) {
    let c = " ";
...
function yo(t, e, r) {
  var _a3;
  let n = t.node, u = ln(t, e), { printer: o, originalText: i, locStart: D } = e, s = (_a3 = o.isBlockComment) == null ? void 0 : _a3.call(o, n);
...
function Ao(t, e, r) {
  var _a3, _b;
  let n = e[Symbol.for("printedComments")], u = (r == null ? void 0 : r.filter) ?? fn, o = new Set((_b = (_a3 = t.node) == null ? void 0 : _a3.comments) == null ? void 0 : _b.filter((i) => !(n == null ? void 0 : n.has(i)) && i.leading && u(i)));
  return o.size === 0 ? "" : t.map(({ node: i }) => o.has(i) ? _o(t, e) : "", "comments").filter(Boolean);
}
function xo(t, e, r) {
  var _a3;
  let n = (_a3 = t.node) == null ? void 0 : _a3.comments, u = new Set(n == null ? void 0 : n.filter((c) => c.trailing)), o = e[Symbol.for("printedComments")], i = (r == null ? void 0 : r.filter) ?? fn, D = new Set(n == null ? void 0 : n.filter((c) => u.has(c) && !(o == null ? void 0 : o.has(c)) && i(c)));
  if (D.size === 0) return "";
  let s = [], a;
...
function it({ plugins: t = [], showDeprecated: e = false } = {}) {
  ...
  for (let u of No(Object.assign({}, ...t.map(({ options: o }) => o), Fn))) !e && u.deprecated || (Array.isArray(u.choices) && (e || (u.choices = u.choices.filter((o) => !o.deprecated)), u.name === "parser" && (u.choices = [...u.choices, ...To(u.choices, r, t)])), u.pluginDefaults = Object.fromEntries(t.filter((o) => {
    var _a3;
    return ((_a3 = o.defaultOptions) == null ? void 0 : _a3[u.name]) !== void 0;
...
function Po() {
  ...
  let t = globalThis, e = (_a3 = t.process) == null ? void 0 : _a3.platform;
  if (typeof e == "string") return e.startsWith("win");
  let r = (_c = (_b = t.Deno) == null ? void 0 : _b.build) == null ? void 0 : _c.os;
...
function vo(t, e) {
  ...
  return (_a3 = Io(r, e.language) ?? _n2(r, e.physicalFile) ?? _n2(r, e.file) ?? yn(r, e.physicalFile) ?? yn(r, e.file) ?? (Ro == null ? void 0 : Ro(r, e.physicalFile))) == null ? void 0 : _a3.parsers[0];
}
var st = vo;
...
async function ui(t, e = {}) {
  ...
  let D = ((_a3 = o.printers) == null ? void 0 : _a3[i.astFormat]) ? o : Hn(r.plugins, i.astFormat), s = await Jn(D, i.astFormat);
...
function ru(t, e, r, n, u) {
  ...
  switch (((_a3 = i.hasPrettierIgnore) == null ? void 0 : _a3.call(i, t)) ? D = tu(t, e, r, n) : u.has(o) ? D = u.get(o) : D = i.print(t, e, r, n), o) {
    case e.cursorNode:
      D = Ee(D, (s) => [ee, s, ee]);
      break;
  ...
  return i.printComment && rt(o.comments) && !((_b = i.willPrintOwnComments) == null ? void 0 : _b.call(i, t, e)) && (D = pn(t, D, e)), D;
}
...
function Du(t, e, r) {
  ...
  let D = ((_a3 = e.printer.features) == null ? void 0 : _a3.experimental_locForRangeFormat) ?? e, s = ir(r, n, e, (f, F) => iu(e, f, F), [], "rangeStart", D);
  if (!s) return;
...
async function hi(t, e) {
  var _a3, _b;
  return (_b = (_a3 = await Ue(e)).hasIgnorePragma) == null ? void 0 : _b.call(_a3, t);
}
...
var gu = "3.9.4";
var fr = {};
yt(fr, { addDanglingComment: () => re, addLeadingComment: () => ce, addTrailingComment: () => fe, getAlignmentSize: () => he, getIndentSize: () => _u2, getMaxContinuousCount: () => yu, getNextNonSpaceNonCommentCharacter: () => Au, getNextNonSpaceNonCommentCharacterIndex: () => vi, getPreferredQuote: () => Tu, getStringWidth: () => Re, hasNewline: () => H, hasNewlineInRange: () => Nu, hasSpaces: () => wu, isNextLineEmpty: () => Ui, isNextLineEmptyAfterIndex: () => gt, isPreviousLineEmpty: () => Mi, makeString: () => ji, skip: () => _e2, skipEverythingButNewLine: () => ut, skipInlineComment: () => Be, skipNewline: () => $, skipSpaces: () => j, skipToLineEnd: () => nt, skipTrailingComment: () => Te, skipWhitespace: () => tn });
function xi(t, e) {
  if (e === false) return false;
